    ...
    return (
        <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
            <AnimationContainer delay={0.1} className="w-full">
                ...
                <p className="mt-4">
                    At <strong>Autiq</strong>, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    When you register for an account or use our services, we may collect personal information such as your name, email address, company details, and payment information.
                </p>
                ...
                <p className="mt-8">
                    We may store the FAQs, documents, and conversation data you upload so the AI support system can generate responses and surface leads in your dashboard.
                </p>
                ...
                <div className="mt-8">
                    ...
                    <ul className="list-disc text-muted-foreground ml-8">
                        <li>Send service updates, onboarding messages, and billing notices.</li>
                ...
                <div className="mt-8">
                    ...
                    <ul className="list-disc text-muted-foreground ml-8">
                        ...
                        <li>Improving support response quality and platform reliability.</li>
                    </ul>
                </div>
                ...
                <p className="mt-8 text-muted-foreground">
                    You can opt out of receiving promotional emails from us by following the unsubscribe instructions in those emails or contacting us directly.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    You have the right to request the deletion of your personal information. Please contact us at support@autiq.ai to make this request.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    We may update this Privacy Policy from time to time. We will notify you of any changes by posting the updated policy on our website and changing the &quot;Last updated&quot; date above.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    If you have any questions or concerns about this Privacy Policy, please contact us at support@autiq.ai.
                </p>

                <p className="mt-8 font-medium">
                    By using Autiq, you acknowledge that you have read, understood, and agree to the terms of this Privacy Policy.
                </p>
            </AnimationContainer>
        </MaxWidthWrapper>
    );
