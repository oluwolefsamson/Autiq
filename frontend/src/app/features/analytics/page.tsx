...
const LeadInsightsPage = () => {
    return (
        <>
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-lg mx-auto">
                        <MagicBadge title="Lead Capture" />
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold font-heading text-center mt-6 !leading-tight">
                            Capture every enquiry in one dashboard
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                            Store customer messages, follow-up status, and support activity so your team can act fast.
                        </p>
                    ...
                    <div className="py-14">
                        <div className="mx-auto px-4 md:px-8">
                            <h2 className="text-center text-sm font-medium font-heading text-neutral-400 uppercase">
                                Built for teams that need follow-up visibility
                            </h2>
                            <div className="mt-8">
                    ...
                    <LampContainer className="max-w-2xl mx-auto">
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            <h2 className="bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-semibold font-heading tracking-tight text-transparent md:text-7xl mt-8">
                                Turn enquiries into follow-ups
                            </h2>
                            <p className="text-muted-foreground mt-6 max-w-lg mx-auto text-base md:text-lg">
                                Track how quickly your team responds and make sure no lead gets lost in the shuffle.
                            </p>
                            <div className="mt-6">
                                <Button asChild>
